...
import stock.thread.BankuaisearchThr;
...
@Results({ @Result(name = "success", type = "redirectAction", params = {
		"actionName", "deal" }) })
public class BankuaiController extends ValidationAwareSupport implements
	...
	private static final Log Logger = LogFactory
			.getLog(BankuaiController.class);
	...
	public HttpHeaders show() throws Exception {
		try {
			...
			String[] params = ((String) paramsInfo.get("bankuai")).split(",");
			...
			ThreadListener.listenThreads(paramsint, resultlstAfterSearch,
					stocklist, BankuaisearchThr.class, threadcount, null);
