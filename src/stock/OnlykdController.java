...
import stock.thread.OnlykdsearchThr;
...
@Results({ @Result(name = "success", type = "redirectAction", params = {
		"actionName", "deal" }) })
public class OnlykdController extends ValidationAwareSupport implements
	...
	private static final Log Logger = LogFactory.getLog(OnlykdController.class);
...
try{
		...
		String[] params = ((String) paramsInfo.get("onlykd")).split(",");
		...
		ThreadListener.listenThreads(paramsint, resultlstAfterSearch, stocklist, OnlykdsearchThr.class, threadcount,null);
