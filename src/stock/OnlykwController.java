...
import stock.thread.OnlykwsearchThr;
...
@Results({ @Result(name = "success", type = "redirectAction", params = {
		"actionName", "deal" }) })
public class OnlykwController extends ValidationAwareSupport implements
	...
	private static final Log Logger = LogFactory.getLog(OnlykwController.class);
	...
	public HttpHeaders show() throws Exception {
		try {
			...
			String[] params = ((String) paramsInfo.get("onlykw")).split(",");
			...
			ThreadListener.listenThreads(paramsint, resultlstAfterSearch,
					stocklist, OnlykwsearchThr.class, threadcount, null);
