...
import stock.thread.ZtsearchThr;
...
@Results({ @Result(name = "success", type = "redirectAction", params = {
		"actionName", "deal" }) })
public class ZtController extends ValidationAwareSupport implements
	...
	private static final Log Logger = LogFactory.getLog(ZtController.class);
	...
	public HttpHeaders show() throws Exception {
		try {
			...
			String[] params = ((String) paramsInfo.get("zt")).split(",");
			...
			ThreadListener.listenThreads(paramsint, resultlstAfterSearch,
					stocklist, ZtsearchThr.class, threadcount, null);
			Logger.info("end");
			...
			if (resultlstAfterSearch.size() == 0) {
				...
				// mp.put("resultlstAfterSearch", resultlstAfterSearch);
