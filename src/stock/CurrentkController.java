...
@Results({ @Result(name = "success", type = "redirectAction", params = {
		"actionName", "deal" }) })
public class CurrentkController extends ValidationAwareSupport implements
	...
	private static final Log Logger = LogFactory
			.getLog(CurrentkController.class);
	...
	public HttpHeaders show() throws Exception {
		try {
			...
			String[] params = ((String) paramsInfo.get("currentk")).split(",");
